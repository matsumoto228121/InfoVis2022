d3.csv("https://matsumoto228121.github.io/InfoVis2022/W04/data.csv")
    .then( data => {
...
class ScatterPlot {
    ...
    update(data) {
        ...
        const space = 10;
        const xmin = d3.min( data, d => d.x ) - space;
        const xmax = d3.max( data, d => d.x ) + space;
        self.xscale.domain( [xmin, xmax] );

        const ymin = d3.min( data, d => d.y ) - space;
        const ymax = d3.max( data, d => d.y ) + space;
